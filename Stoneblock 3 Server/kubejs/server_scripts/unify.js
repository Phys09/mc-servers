...
onEvent("recipes", (event) => {
  const dontReplaceMe = {
    not: [
      ...
      { id: "ae2:network/cables/glass_yellow" },
      { id: "ae2:network/cables/smart_yellow" },
      { id: "ae2:network/cables/covered_yellow" },
      { id: "ae2:network/cables/dense_covered_yellow" },
      { id: "ae2:network/cables/dense_smart_yellow" },
    ],
  };
